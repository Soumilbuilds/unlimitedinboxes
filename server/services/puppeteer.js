...
// Generates 6-digit TOTP codes from a Base32 secret using HMAC-SHA1
// (time-based, 30-second window). Handles both RFC 4648 standard base32
// and Microsoft's lowercase base32 alphabet.
...
async function handleTwoFactorPrompt(page, getTotpCode) {
 ...
 // No automatic TOTP — wait up to 60 seconds for manual user entry
